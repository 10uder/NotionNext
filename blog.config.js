...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'louder', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Speak louder.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kitano.blue', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Louder, 博客, blog', // 网站关键词 英文逗号隔开
